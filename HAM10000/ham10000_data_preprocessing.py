...
for file in l:
	...
	# for i in range(20):
	# 	ax[i].imshow(Fill[:,:,i], cmap='gray')

	# plt.savefig('filtration.png')
	...
	dgm_X_xyz.append( lower_star_img(-masked_img_xyz[:,:,0]) )
	dgm_Y_xyz.append( lower_star_img(-masked_img_xyz[:,:,1]) )
	dgm_Z_xyz.append( lower_star_img(-masked_img_xyz[:,:,2]) )
...
diagrams = pd.DataFrame(index=range(len(labels)))

diagrams['dgm_R_rgb'] = dgm_R_rgb
diagrams['dgm_G_rgb'] = dgm_G_rgb
diagrams['dgm_B_rgb'] = dgm_B_rgb

diagrams['dgm_H_hsv'] = dgm_H_hsv
diagrams['dgm_S_hsv'] = dgm_S_hsv
diagrams['dgm_V_hsv'] = dgm_V_hsv

diagrams['dgm_X_xyz'] = dgm_X_xyz
diagrams['dgm_Y_xyz'] = dgm_Y_xyz
diagrams['dgm_Z_xyz'] = dgm_Z_xyz
