"""This set of functions computes features for use in machine learning models from persistence diagrams.  It returns
...
def adaptive_features(X_train, X_test, model, y_train, d=25):
    ...
    from adaptive template functions when given a training and testing set of persistence diagrams
    
    Args:
       train (array):  training set
       test (array):  testing set
       d (double):  parameter, default is 25.
    
    Kwargs:
       model (string): choice of adaptive template function from the following:
       ['gmm', 'hdb', 'cder']
...
def carlsson_coordinates(X_train, X_test):
    """This function computes a training and testing set of features
    of Carlsson Coordinates when given a training and testing set of persistence diagrams
...
def landscape_features(X_train, X_test, num_landscapes=5, resolution=100):
    ...
    Args:
       train (array):  training set
       test (array):  testing set
       num_landscapes (double):  the number of landscapes, default is 5
       resolution (int): resolution, default is 100
